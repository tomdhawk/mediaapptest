...
// Importeren van de Movie interface
...
export class MovieDataService {
  ...
  // Getter maken van de movies en deze in een Array steken van Movie[]
  public getMovies(): Movie[] {
    return this.movies;
  }

  // Dummy gegevens array (private)
  private movies: Movie[] = [
    {
      id: 1,
      title: 'Star Wars',
      poster: 'https://image.tmdb.org/t/p/w185/btTdmkgIvOi0FFip1sPuZI2oQG6.jpg',
      plot: 'Princess Leia is captured and held hostage by the evil Imperial forces in their effort to take \
      over the galactic Empire.Venturesome Luke, Skywalker and dashing captain Han Solo team together with the loveable robot…',
      year: 1977,
      seen: true,
    },
    {
      ...
      plot: 'Thirty years after defeating the Galactic Empire, Han Solo and his allies face a new threat \
      from the evil Kylo Ren and his army of Stormtroopers.',
      year: 2015,
      seen: false,
    },
    {
      ...
      year: 2017,
      plot: 'Rey develops her newly discovered abilities with the guidance of Luke Skywalker,\
